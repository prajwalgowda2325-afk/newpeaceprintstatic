    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center">
        <div className="max-w-4xl mx-auto">
          {/* Brand Name */}
          <h1 className="animate-fade-in-up font-display text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-bold text-foreground leading-tight mb-4 sm:mb-6">
          ...
          {/* Tagline */}
          <p className="animate-fade-in-delay-2 text-base sm:text-xl md:text-2xl text-muted-foreground max-w-xl mx-auto px-4">
